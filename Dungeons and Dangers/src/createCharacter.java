...
public class CreateCharacter
{
  public static UserCharacter createPlayer(UserCharacter userCharacter)
  {
    ...
    FancyPrint.setDelay("To choose the class Mage input (1) and to choose the class Knight input (2), to be a Assassin input (3) and to become a Soldier input (4)", 10, true);
   
    //Saving input (attribute) of the class.
    Integer classInput = CustomScan.scanInt();

    FancyPrint.setDelay("To choose a staff as your weapon input (1) and to choose a Sword as your weapon input (2) to use a Dagger input (3) and to use a Gun input (4)", 10, true);
   
    //Saving input (attribute) of the weapon.
    Integer weaponInput = CustomScan.scanInt();

    //====================================================================================================================
    //Saving all three inputs of sex, class and weapon into one Ineteger to be input into the Hashmap.
    ...
    FancyPrint.setDelay("You are a " + userCharacter.getGender() + " " + userCharacter.getRole() + " wielding a " + userCharacter.getWeapon(), 10, true);
